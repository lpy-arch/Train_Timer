    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 16px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button onClick={() => setShowRMCalc(true)} style={pillBtn}>RM换算</button>
          {!running && <button onClick={() => setShowImport(true)} style={pillBtn}>导入</button>}
          {!running && <button onClick={openEdit} style={pillBtn}>编辑选项</button>}
        </div>
      </div>
